...
namespace easy3d 
{
	...
	public:
		...
		static easy3d::SurfaceMesh *surfaceMesh;
	...
	protected:
		...
		bool drawValidScalarGird_ = false;
		bool drawMeshTriangles_ = false;
		bool drawMeshFilling_ = false;

		void pathSplit(const std::string &path, std::string &name, std::string &directory);
